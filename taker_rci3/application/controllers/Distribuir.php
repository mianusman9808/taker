	...
	function index()
	{
		...
		if ($this->form_validation->run())
		{
			if ($this->input->post('agregar'))
			{
				...
				$this->session->set_flashdata('success', $this->input->post('cantidad').' valores Agregados al vendedor');
			...
			elseif($this->input->post('quitar'))
			{
				...
				$this->session->set_flashdata('success', $this->input->post('cantidad').' valores Quitados al vendedor');
				redirect('distribuir/index');
			}
		}
		else
