...
<table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#999999"  class="tablaContenido">
  ...
  <tr>
    <td colspan="4" class="tdContenidoItem">
        <?php $this->load->view("pdf/template/cobertura_puerto_natales");?>
        
    </td>
  </tr>
<?php $this->load->view("pdf/template/costos");?>
</table>


<?php $this->load->view("pdf/template/contacto_siniestros",array('otros_paises'=>false));?>
<?php $this->load->view("pdf/template/pie");?>
