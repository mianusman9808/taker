...
<?php endif ?>
    ...
    <input name="submit" type="submit" value="<?php echo lang('dt_add'); ?>" class="btn btn-large btn-primary" />                
    ...
    <?php foreach( $fields as $field ): ?>     
        <?php if ($field['add']):
                  if ($field['form_control_add']){
                        $field['form_control']=$field['form_control_add'];
                  }
                ...
                if(empty($field['add_attributes']['class'])){
                    $params['class']="form-control";
                    $dropdown_params='class="form-control" id="'.$field['id'].'" ';  
                }else{
                    //custom class
                    $dropdown_params='class="'.$field['add_attributes']['class'].'" id="'.$field['id'].'" ';
				...
				$params=$params+$field['add_attributes'];
				

                   
			    if($field['disabled']){
					 $params['disabled']="disabled";
					 $dropdown_params.=' disabled="disabled"';
				}
            ...
            <tr>
                ...
                <?php if ($field['form_control']=="upload"):?>
					<?php echo iframe_subir($field['alias']); ?>
                <?php endif; ?>   
	...
	<?php if ($form_edit_buttom_bottom):?> 
	 ...
	 <table class="table">    
        <tr>
            <td><span class="requerido">*</span> <?php echo lang('dt_requerido'); ?></td>
            <td>
                <input name="submit" type="submit" value="<?php echo lang('dt_add'); ?>" class="btn btn-large btn-primary" />                
                <a href="<?php echo $back_url; ?>" class="btn btn-large datagrid_link"><?php echo lang('dt_cancel'); ?></a>
            </td>
